...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotPairWhoMessage":["PairWho.Msg"],"Load":["String.String"]}},"PairWho.Msg":{"args":[],"tags":{"DoLoad":[],"Load":["String.String"],"NewPerson":["String.String"],"AddPerson":[],"RemovePerson":["String.String"],"Shuffle":[],"NewMobs":["List.List String.String"]}},"String.String":{"args":[],"tags":{"String":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});}(this));