...
var $author$project$Ladder$init = function (names) {
	var l1 = A2(
		$elm$core$List$map,
		function (n) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'NewMobs':
				...
				var a = A2($elm$core$List$take, len, l);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$Main$GotLadderMessage = function (a) {
	return {$: 'GotLadderMessage', a: a};
};
...
var $author$project$Ladder$tableRow = F2(
	function (n, row) {
		var cell = function (v) {
			return A2(
				$elm$html$Html$td,
...
var $author$project$Ladder$tableBody = function (model) {
	return A2(
		$elm$html$Html$tbody,
		_List_Nil,
...
var $author$project$People$viewMob = function (mob) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('person-name')
						]),
					_List_fromArray(
						[
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('people people-group')
			]),
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$text('Mob Randomizer')
		]));
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Main$selection(model),
				$author$project$Main$ladder(model),
