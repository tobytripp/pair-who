...
var $author$project$PairWho$load = _Platform_incomingPort('load', $elm$json$Json$Decode$string);
var $author$project$PairWho$subscriptions = function (model) {
	return $author$project$PairWho$load($author$project$PairWho$Load);
};
...
var $author$project$PairWho$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$PairWho$initialModel, $author$project$PairWho$initialCmd);
		},
		subscriptions: $author$project$PairWho$subscriptions,
		update: $author$project$PairWho$update,
		view: $author$project$PairWho$view
	});
_Platform_export({'PairWho':{'init':$author$project$PairWho$main(
